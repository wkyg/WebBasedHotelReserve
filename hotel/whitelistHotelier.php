        ...
        <main class="container">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Whitelist hotelier</h3>
                </div>
                <div class="card-body">
                    <div class="row mb-3">               
                        <div class="col-lg">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="whitelistHotelierToDB.php?hotelier_id=<?=$hotelier_id?>" class="btn btn-success" data-toggle="tooltip" data-placement="right" title="Are you sure 
                                    you want to whitelist selected user?">Whitelist selected hotelier</a>
                                </div>
                            </div>
                        </div>
                    </div>
